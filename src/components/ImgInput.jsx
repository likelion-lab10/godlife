  ...
  return (
    <>
      <form name='recruitment' onSubmit={onSubmit}>
        ...
        <textarea className='bg-[#EAEAEA] w-[329px] h-[208px] rounded-[15px] shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] cursor-text placeholder:indent-2.5 leading-10' value={challenge} onChange={onChange} placeholder='내용을 입력해 주세요'></textarea>
        <SubmitButton />
      </form>
    </>
  )
